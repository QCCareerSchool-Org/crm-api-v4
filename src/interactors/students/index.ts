...
export const chargePaymentMethodInteractor = new ChargePaymentMethodInteractor(prisma, remotePrisma, bigJsDecimalService, paysafeServiceFactory, winstonLoggerService);
